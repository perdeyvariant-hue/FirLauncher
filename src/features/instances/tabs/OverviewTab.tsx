  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="panel flex flex-col gap-3 p-4">
        <div>
          <h3 className="text-xs font-semibold text-text">Папка сборки</h3>
          <p className="mt-1 text-xs leading-relaxed text-text-dim">
            Каждая сборка полностью изолирована: свои <code className="font-mono">mods/</code>,{' '}
            <code className="font-mono">config/</code>, <code className="font-mono">saves/</code>,{' '}
            <code className="font-mono">resourcepacks/</code> и <code className="font-mono">logs/</code>.
          </p>
        </div>
        <div>
          <Button
