...
- Избранное, группы и ярлык на рабочий стол, который сразу запускает нужную сборку.
...
Вход через Microsoft в лаунчере уже есть, но в официальных сборках заработает после того, как
Mojang одобрит приложение. Пока играйте с оффлайн-аккаунтом — для одиночной игры его хватает.
