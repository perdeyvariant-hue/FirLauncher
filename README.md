...
**Где CurseForge?**
Там же, где Modrinth: в браузере модов и модпаков переключатель источника. Работают поиск,
установка, зависимости, выбор версии и обновления. Если автор мода запретил скачивание через
сторонние лаунчеры, CurseForge не отдаёт ссылку на файл — лаунчер честно скажет об этом и
предложит открыть страницу мода.
